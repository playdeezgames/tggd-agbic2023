...
Public Class ConsumableEffectHandlers_should
    ...
    Public Sub allow_eating_rat_corpses()
        ...
        character.Setup(Function(x) x.GetStatistic(StatisticTypes.Health)).Returns(1)
        character.Setup(Function(x) x.GetStatistic(StatisticTypes.MaximumHealth)).Returns(2)
        ...
        character.Verify(Function(x) x.GetStatistic(StatisticTypes.Health, 0))
        character.Verify(Function(x) x.GetStatistic(StatisticTypes.MaximumHealth, 0))
