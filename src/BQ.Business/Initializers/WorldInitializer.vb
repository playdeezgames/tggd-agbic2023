Friend Module WorldInitializer
    ...
    Private Sub StitchTownToWilderness(world As IWorld)
        ...
        townMap.GetCell(townMap.Columns \ 2, townMap.Rows - 1).Effect =
            townMap.CreateEffect()
        TriggerExtensions.SetEffectType(townMap.GetCell(townMap.Columns \ 2, townMap.Rows - 1).Effect, EffectTypes.Teleport)
        ...
        townMap.GetCell(townMap.Columns \ 2, 0).Effect =
            townMap.CreateEffect()
        TriggerExtensions.SetEffectType(townMap.GetCell(townMap.Columns \ 2, 0).Effect, EffectTypes.Teleport)
        ...
        townMap.GetCell(0, townMap.Rows \ 2).Effect =
            townMap.CreateEffect()
        TriggerExtensions.SetEffectType(townMap.GetCell(0, townMap.Rows \ 2).Effect, EffectTypes.Teleport)
        ...
        townMap.GetCell(townMap.Columns - 1, townMap.Rows \ 2).Effect =
            townMap.CreateEffect()
        TriggerExtensions.SetEffectType(townMap.GetCell(townMap.Columns - 1, townMap.Rows \ 2).Effect, EffectTypes.Teleport)
        ...
        TriggerExtensions.SetEffectType(townCell.Effect, EffectTypes.Teleport)
