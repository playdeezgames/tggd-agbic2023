Module PotterEffectHandlers
    Friend Sub DoPotterMakePot(character As ICharacter, effect As IEffect)
        ...
        character.World.CreateMessage().
            AddLine(4, $"{CharacterExtensions.Name(character)} loses {price} jools").AddLine(10, $"{CharacterExtensions.Name(character)} gains 1 {ToItemTypeDescriptor("ClayPot").Name}")
    End Sub
End Module
