...
Public Class CharacterExtensions_should
    ...
    Public Sub deny_sleep_for_avatars_in_nonwilderness()
        ...
        map.Verify(Function(x) x.GetFlag(FlagTypes.CampingAllowed))
    ...
    Public Sub allows_sleep_for_avatars_in_wilderness()
        ...
        character.Setup(Function(x) x.GetStatistic(StatisticTypes.MaximumEnergy)).Returns(10)
        ...
        character.SetupGet(Function(x) x.World).Returns(world.Object)
        world.Setup(Function(x) x.CreateMessage()).Returns(message.Object)
        map.Setup(Function(x) x.GetFlag(FlagTypes.CampingAllowed)).Returns(True)
        ...
        character.VerifyGet(Function(x) x.IsAvatar)
        character.VerifyGet(Function(x) x.CharacterType)
        character.Verify(Function(x) x.GetStatistic(StatisticTypes.MaximumEnergy))
        character.Verify(Function(x) x.GetStatistic(StatisticTypes.Energy))
        character.Verify(Function(x) x.GetStatistic(StatisticTypes.Peril))
    ...
    Public Sub attempts_to_build_fire()
        ...
        character.Setup(Function(x) x.GetStatistic(StatisticTypes.Energy)).Returns(1)
